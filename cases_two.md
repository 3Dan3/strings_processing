...
However, if we have a " TLD (top-level domain) **exceeding six letters**, our pattern won't match, like in the next example:
...
We now want to extract the country for each case in the *athlete* column. Again, we can first use the sub\_string function
...
```
    ...
    ## 1 7.61   NA     Peter O'Connor      IRE        Dublin, Ireland 1901-08-05
    ## 2 8.21  0.0       Ralph Boston      USA  Walnut, United States 1960-08-12
    ## 3 7.89   NA     DeHart Hubbard      USA Chicago, United States 1925-06-13
    ## 4 8.35  0.0 Igor Ter-Ovanesyan      URS    Mexico City, Mexico 1967-10-19
    ## 5 7.98  0.5       Chuhei Nambu      JPN           Tokyo, Japan 1931-10-27
